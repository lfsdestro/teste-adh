...
import barba from '../images/barba.jpg'
        ...
        <div className='col-12' >
            <div className='row p-lg-3 p-2 appointment-button-group g-0' style={{ width: '85%' }}>
                <div className='col d-flex flex-row align-items-center justify-content-around p-3' style={{ backgroundColor: '#f6f6f6', height: '3rem', overflowY: 'hidden', overflowX: 'auto' }}>
                    <button className='btn  appointment-btn-group appointment-btn-group-active'>Lista de pacientes</button>
                    <button className='btn appointment-btn-group'>Horário de consulta</button>
                    <button className='btn appointment-btn-group'>Comentários</button>
                </div>
            </div>
                    ...
                    <div className='row p-0 m-0'>
                        <div className="col-12 my-2 d-flex flex-row bg-white align-items-center justify-content-between p-3 overflow-auto" style={{ width: '100%' }}>
                            <div className='d-flex flex-row m-0 p-0' style={{ flexShrink: '0' }}>
                                <img src={roger} className='m-0 rounded me-2 square-profile' height='75' width='75' alt="img" />
                                <div className='align-self-center'>
                                    <span className="p-0 m-0 text-secondary" >Paciente</span>
                                    <p className="p-0 m-0 fw-bold">Gold Roger</p>
                                </div>
                            </div>
                            <div className="vl"></div>
                            <div className='align-self-center ' style={{ flexShrink: '0' }}>
                                <p className="p-0 m-0  text-secondary text-center">Station</p>
                                <p className="p-0 m-0 fw-bold text-center">Hospital Distrital de East Blue</p>
                            </div>
                            <div className="vl"></div>

                            <div style={{ display: 'grid', placeItems: 'center' }}>
                                <span className=' ' style={{ fontSize: '19px', fontWeight: '900' }}>1</span>
                                <span className=' ' style={{ fontSize: '19px', fontWeight: '900' }}>AGO</span>
                                <small className='text-secondary text-center' style={{whiteSpace:'nowrap'}}>1:00 PM-2:00 PM</small>
                            </div>
                            <div className="vl"></div>

                            <div style={{ flexShrink: '0' }}>
                                <a className='see-more-from-appoint'>Veja mais</a>
                            </div>
                        </div>
                        <div className="col-12 my-2 d-flex flex-row bg-white align-items-center justify-content-between p-3 overflow-auto" style={{ width: '100%' }}>
                            <div className='d-flex flex-row m-0 p-0' style={{ flexShrink: '0' }}>
                                <img src={barba} className='m-0 rounded me-2 square-profile' height='75' width='75' alt="img" />
                                <div className='align-self-center'>
                                    <span className="p-0 m-0 text-secondary" >Paciente</span>
                                    <p className="p-0 m-0 fw-bold">Barba Branca</p>
                                </div>
                            </div>
                            <div className="vl"></div>
                            <div className='align-self-center ' style={{ flexShrink: '0' }}>
                                <p className="p-0 m-0  text-secondary text-center">Estação</p>
                                <p className="p-0 m-0 fw-bold text-center">Hopital da Red Line</p>
                            </div>
                            <div className="vl"></div>
