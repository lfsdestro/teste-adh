            ...
            <form>
                ...
                <div className="row g-0 text-white paymentfontclamp" style={{ height: '140px' }}>
                        ...
                        <div className="row ps-3">
                            ...
                            <ul className='list-unstyled'>
                                <li>
                                    ...
                                    <span className='ms-2' style={{ fontWeight: '200' }}>Nico Robin</span></li>
                                <li className='mt-1'>
                                    <span className='fw-bold'>Horário da consulta:</span>
                    ...
                    <div className="col-lg payment-background ms-lg-1 mt-2 mt-lg-0  d-flex align-items-center justify-content-start flex-row">
                        <div className="row ps-3 ">
                            <ul className='list-unstyled'>
                                <li >
                                    <span className='fw-bold'>Nome do Médico:</span>
                                    <span className='ms-2' style={{ fontWeight: '200' }}>Roberto Romano</span>
                                </li>
                            </ul>
                ...
                <div className="row g-0 payment-background my-2 text-white overflow-auto" style={{ height: '140px',whiteSpace:'pre-wrap' }}>
                    <div className="col-12 p-3 chiefcomplain" >
                        <p className='fw-bold'>Queixa principal:</p>
                ...
                <div class="row  text-white ">
                    <div class="col-lg  d-flex flex-row justify-content-around my-2 p-4">
                        <div class="row d-flex flex-column  justify-content-between p-4 payment-cards">
                            ...
                            <div class="my-3">
                                <button class="btn  btn-light text-danger rounded shadow-sm m-auto">Confirme</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg d-flex flex-row justify-content-around my-2 p-4">
                    ...
                    <div class="col-lg d-flex flex-row justify-content-around my-2 p-4">
                        <div class="row d-flex flex-column justify-content-between p-4 payment-cards">
                            <div>
                                <h2 class='text-start'>Emergencia</h2>
                                <h4 class='text-start xxx-text-shadow'>RS: XXX</h4>
                            </div>
                            <div class="my-3">
                                <button class="btn  btn-light text-danger rounded pay-btn-shadow m-auto ">Confirme</button>
                            </div>
                        </div>
                    </div>
