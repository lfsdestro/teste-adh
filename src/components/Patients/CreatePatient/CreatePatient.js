        ...
        return(
            <div className='page-content px-lg-5  py-2 overflow-hidden container ' id='CreatePatient-content' >
                ...
                <div className="row g-0">
                    { this.state.page === 1 &&<p className='fw-bold' style={{fontSize:'1.563rem'}}>Informaçôes do paciente</p>}
                    { this.state.page === 2 &&<p className='fw-bold' style={{fontSize:'1.563rem'}}>Exame geral</p>}
                ...
                <div className="row mt-4">
                    <div className='d-flex flex-row justify-content-end'>
                        ...
                        {this.state.page !== 3 && <button className='btn cp-btn shadow-sm me-4' onClick={this.handleClick}>Próximo</button>}
                        {this.state.page === 3 && <button className='btn  cp-btn shadow-sm me-4' onClick={this.handleClick}>Enviar</button>}

                        { <span className='text-primary text-decoration-underline'> mostrando {this.state.page} de 3</span>}
                    </div>
                </div>
            </div>
        )
