...
class PatientListView extends Component {
    ...
    return (
        <div className='col-xl-3 col-12 order-xl-first  order-last me-2 bg-white shadow-sm rounded ' >
            ...
            <button className='btn   fw-bold my-4' style={{borderRadius:'2.5rem', backgroundColor:'#7682EF', color:'white'}}>Criar Paciente</button>
            </Link>
            <div className="input-group mb-3 input-group-sm  px-2 py-1 border  " style={{borderRadius:'3.125rem'}} >
                <input type="search" className="form-control border-0" placeholder="Lista de pacientes" aria-label="Patient List" aria-describedby="inputGroup-sizing-sm"
