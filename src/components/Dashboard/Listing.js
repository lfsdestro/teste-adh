        ...
        <>
                ...
                <table className='table  table-borderless  table-hover  ' style={{fontSize:"0.688rem" ,boxSizing:'border-box'}} >
                    ...
                    <thead >
                        <tr className='list-fonts'>
                            <td colSpan='4'>  <span className=' text-secondary text-start fw-bold ps-1'>Lista de pacientes</span></td>
                            <td><a href="#" className='text-decoration-none text-end seemore fw-bold  me-2'>Veja mais</a></td>
                        </tr>

                        <tr>
                            <th scope="col" className='col'>SN</th>
                            <th scope="col" className='col'>Nome</th>
                            <th scope="col" className='col'>Idade</th>
                            <th scope="col" className='col'>Gênero</th>
                            <th scope="col" className='col'>Última consulta</th>
                        </tr>
                    </thead>
                    <tbody>
                        {patientList}
            ...
            <div className='scrollbar col g-0 px-sm-2' style={{height:'250px',overflow:'auto',scrollbarGutter:'stable'}}>
                <table className='table  table-borderless  table-hover' style={{fontSize:"0.688rem" ,boxSizing:'border-box'}} >
                    ...
                    <thead >
                        <tr className='list-fonts'>
                            <td colSpan='4'>  <span className=' text-secondary text-start fw-bold ps-1'>Lista de Médicos</span></td>
                            <td><a href="#" className='text-decoration-none text-end seemore fw-bold  me-2'> Veja mais </a></td>
                        </tr>
                        <tr >
                            <th scope="col" className='col'>SN.</th>
